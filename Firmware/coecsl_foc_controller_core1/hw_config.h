...
#define DRV_nFAULT      GPIOD, GPIO_PIN_2   // DRV nFAULT pin (used with DRV8323RH)
#define USING_DRV_RS //  select between DRV8323RS (USING_DRV_RS) and DRV8323RH (USING_DRV_RH)
